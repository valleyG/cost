...
<div class="row">
    <div class="col-xs-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <%--定义表格，而且表格必须得有thead 和 tbody
                data-graph-container-before="1" 表格变成图形容器
                data-graph-height="250" ：表的高度
                 data-graph-type="column" 柱型图
                --%>
                <table class="salaryChart" style="display: none;" data-graph-container-before="1"
                       data-graph-height="250" data-graph-type="column">
                    <thead>
                    <tr>
                        <th>月份</th>
                        <th>底薪</th>
    ...
    <div class="col-xs-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="salaryChart" style="display: none;" data-graph-container-before="1"
                       data-graph-height="250" data-graph-type="pie">
                    <thead>
                    <tr>
                        <th>月份</th>
                        <th>底薪</th>
