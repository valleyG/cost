...
<body>
	...
	<form action="expense/manageAuditExpense" id="f1" method="post" class="form-horizontal">
		...
		<table class="table" id="tab1" >
			...
			<c:forEach items="${details }" var="di">
				<tr>
					<td>${di.detailId }</td>
					<td>${di.costName }</td>
					<td>${di.expenseMoney }</td>
					<td>${di.expenseDesc }</td>
				</tr>
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">经理审核</h5>
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<a href="expense/queryExpense?cmd=queryManageExpense" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
