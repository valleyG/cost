		...
		<table class="table" id="tab1" >
			...
			<c:forEach items="${details }" var="detail">
				<tr>
					...
					<td>
					<input type='text' value='${detail.expenseMoney }' id='money'  name='detailMoneys' class='form-control' style='width:100px'>
					</td>
					<td>
					<input type='text' name='detailDescs' value="${detail.expenseDesc }" class='form-control'>
					</td>
					<td><a href='javascript:void(0)' class='btn btn-danger' onclick='del(this)' >删除</a></td>
				</tr>
