...
<form action="expense/queryExpenseList" id="f1" method="post" class="form-inline">
    <div class="row alert alert-info" style="margin: 0px; padding: 5px;">
        <div class="form-group">
            <label>报销人:</label> <input type="text" class="form-control" name="userName" value="${expense.userName }"
            ...
            <label>开始时间:</label> <input type="text" class="form-control " type="text"
                                        ...
                                        value='${expense.startDate }' placeholder="请输入开始时间"/>
    ...
    <div class="row" style="padding: 15px;">
        <d:table class="table table-hover table-condensed" name="expenses" pagesize="10"
                 requestURI="expense/queryExpenseList">
            ...
            <d:column value="查看详情" title="查看详情" href="expense/showExpenseDetails" paramId="expenseId"
                      paramProperty="expenseId"></d:column>
        </d:table>
    </div>
</form>
</body>
