	...
	<form action="system/userQuery" id="f1" class="form-inline" method="post">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			<div class="form-group" >
				<label>用户编号:</label> 
				<input type="text" class="form-control" name="userId" value="${queryCon.userId==0?'':queryCon.userId }" placeholder="请输入用户编号" />
				<label>用户姓名:</label>
				<input type="text" class="form-control" name="userName" value="${queryCon.userName }"  placeholder="请输入用户姓名" />
			</div>
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="userList" pagesize="8" requestURI="system/userQuery">
