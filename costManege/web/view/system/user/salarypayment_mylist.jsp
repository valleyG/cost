	...
	<form action="system/queryMySalary" id="f1" method="post" class="form-inline">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			<div class="form-group">
				<label>发放月份:</label>
				<input type="text" class="form-control" name="salaryMonth" value='<fmt:formatDate value="${salary.salaryMonth }" pattern="yyyy-MM"/>'
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="salaries" pagesize="10" requestURI="system/queryMySalary">
