...
<form action="system/updateMyUser" id="f1" method="post" class="form-horizontal">
    <input type="hidden" value="${userInfo.roleId}" name="roleId">
    <input type="hidden" value="${userInfo.userMark}" name="userMark">
    ...
    <div class="row">
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" required name="userName" value="${userInfo.userName }"
                           placeholder="请输入用户姓名"/>
                </div>
            </div>
        </div>
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" name="userAge" value="${userInfo.userAge }"
                           placeholder="请输入用户年龄"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" name="userPhone" value="${userInfo.userPhone }"
                           placeholder="请输入电话号码"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <p class="form-control-static">${userInfo.userBasic}</p>
                    <input type="hidden" name="userBasic" value="${userInfo.userBasic}">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" value="${userInfo.userPwd }" required name="userPwd"
                           placeholder="请输入用户密码"/>
                </div>
            </div>
        </div>
